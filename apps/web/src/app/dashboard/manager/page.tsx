...
export default function ManagerDashboard() {
  ...
  const sidebarItems = [
    { id: 'overview', label: 'Overview', icon: '📊', path: '/dashboard/manager' },
    ...
    { id: 'team', label: 'Team', icon: '👥', path: '/admin/users' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50">
      ...
      <div className="fixed inset-y-0 left-0 z-50 w-64 bg-white/90 backdrop-blur-md border-r border-orange-100">
          ...
          <div className="p-6 border-b border-orange-100">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-orange-600">Manager</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-green-600">$89K</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-orange-600 font-medium">Manager Dashboard</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Search properties, tasks, team..."
                    className="w-80 pl-12 pr-4 py-3 bg-white/70 backdrop-blur-sm border border-orange-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300"
                  />
                  <svg className="absolute left-4 top-3.5 h-5 w-5 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                </div>

                {/* Notifications */}
                <button className="relative p-3 text-orange-600 hover:text-orange-700 hover:bg-orange-50 rounded-2xl transition-all duration-300 group">
                ...
                {/* Help */}
                <button className="p-3 text-orange-600 hover:text-orange-700 hover:bg-orange-50 rounded-2xl transition-all duration-300">
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="relative group">
                  <button className="flex items-center space-x-3 p-3 text-orange-600 hover:text-orange-700 hover:bg-orange-50 rounded-2xl transition-all duration-300">
                  ...
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-orange-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                    <div className="p-4">
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-orange-600">Manager</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <a href="#" className="flex items-center space-x-3 p-3 text-gray-700 hover:bg-orange-50 rounded-xl transition-colors">
                          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-3xl p-8 text-white shadow-2xl">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-orange-100 text-lg">Lead your team and manage operations effectively</p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-100 hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-orange-600 text-sm font-medium">+3 this month</p>
                    </div>
                    <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl flex items-center justify-center">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-100 hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-red-600 text-sm font-medium">5 due today</p>
                    </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-100 hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-green-600 text-sm font-medium">+8% vs last month</p>
                    </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-100">
                ...
                <div className="space-y-4">
                  {[
                    { action: 'Task completed', task: 'Property inspection', time: '1 hour ago', type: 'success' },
                    { action: 'New maintenance request', property: 'Downtown Condo', time: '3 hours ago', type: 'warning' },
                    { action: 'Team member assigned', user: 'John Doe', time: '5 hours ago', type: 'info' },
                    { action: 'Payment processed', amount: '$1,250.00', time: '1 day ago', type: 'success' }
                  ].map((activity, index) => (
                    <div key={index} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl hover:bg-orange-50 transition-colors">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">{activity.task || activity.property || activity.user || activity.amount}</p>
                      </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-100">
                ...
                <div className="space-y-3">
                  <button className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-3 px-4 rounded-xl font-medium hover:shadow-lg transition-all duration-300">
                    Assign Task
                  </button>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-100">
                ...
                <div className="space-y-4">
                  {[
                    { event: 'Team Meeting', date: 'Tomorrow, 9:00 AM', location: 'Conference Room' },
                    { event: 'Property Inspection', date: 'Dec 20, 2:00 PM', property: 'Sunset Villa' },
                    { event: 'Client Meeting', date: 'Dec 22, 11:00 AM', location: 'Office' }
                  ].map((event, index) => (
                    <div key={index} className="p-4 bg-orange-50 rounded-xl border border-orange-200">
                      ...
                      <p className="text-sm text-gray-600">{event.location || event.property}</p>
                    </div>
                  ))}
                </div>
              </div>
