...
import { ChevronLeft, ChevronRight, Calendar, DollarSign, Users, Home, MapPin, Clock, Star } from 'lucide-react';
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{monthlyStats.occupancyRate.toFixed(1)}%</p>
              </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">${Math.round(monthlyStats.averagePrice)}</p>
              </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{monthlyStats.totalBookings}</p>
              </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{monthlyStats.totalNights}</p>
              </div>
        ...
        <div className="grid grid-cols-7 gap-1">
          ...
          {calendarDays.map((day, index) => (
            <div
              ...
              className={`min-h-[120px] p-2 border border-gray-200 rounded-lg cursor-pointer transition-all hover:shadow-md ${
            ...
            >
              <div className="flex justify-between items-start mb-1">
                ...
                <span className={`text-xs px-1 py-0.5 rounded ${
                  ...
                  {day.isAvailable ? 'Available' : 'Booked'}
                </span>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className={`text-xs px-1 py-0.5 rounded ${getDemandColor(day.demandLevel)}`}>
                  {day.demandLevel.charAt(0).toUpperCase() + day.demandLevel.slice(1)} Demand
                </div>
